...
const data = fs.readFileSync('./czechintjlinks.txt').toString();
...
for (var i = 0; i < myData.length; i++) {
	...
	if (czechHTML.find("[id*='" + "Interjection" + "']").val() != undefined) {
...
fs.writeFileSync("intjs.json", JSON.stringify(ret), 'utf8');